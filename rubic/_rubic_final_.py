...
class Cube(object):
    def __init__(self, row, col, numLine= 20): 
        ...
        for i in range(-1, 2):
            for j in range(-1, 2):
                self.yz_0.append(self.__init_yz__(refer, _len_*i, _len_*j, _len_ - 2))
                self.yz_1.append(self.__init_yz__(-refer, _len_*i, _len_*j, _len_ - 2))
                self.xz_0.append(self.__init_xz__(_len_*i, refer ,_len_*j, _len_ - 2))
                self.xz_1.append(self.__init_xz__(_len_*i, -refer, _len_*j, _len_ - 2))
                self.xy_0.append(self.__init_xy__(_len_*i, _len_*j, refer, _len_ - 2))
                self.xy_1.append(self.__init_xy__(_len_*i, _len_*j, -refer, _len_ - 2))
